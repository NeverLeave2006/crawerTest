...
for i in range(1,23):
    ...
    if i==1:
        url = "http://mtrtxz.com/yazhourenti/2018/0616/6320.html"  # URL不变
    else:
        url = "http://mtrtxz.com/yazhourenti/2018/0616/6320_"+str(i)+".html"  # URL不变
    ...
    # 保存网页到本地
    file_obj = open('国模小露(舒芘)高清晰私拍高清人体_'+str(i)+'.html', 'w')  # 以写模式打开名叫 douban.html的文件
